...
export class LevelManager{
    ...
    setupLevel(level) {
        ...
        else if(level == 7) // ((1+1)+2)+4) = 8
        {
            this.addEntity(MetaNodiLedBuilding  , -3, 0, 1, 1);
        ...
        else if(level == 12) // if(a>5) b= a else c = a
        {
        ...
        else if(level == 13) // 0-1-1-1-1-1=-5
        {
        ...
        else if(level == 14) // Main > 3+1+1+1 = 6
        {
